...
# AptX
PRODUCT_COPY_FILES += \
    device/huawei/angler/aptx/lib/libaptX_encoder.so:system/lib/libaptX_encoder.so \
    device/huawei/angler/aptx/lib/libaptXHD_encoder.so:system/lib/libaptXHD_encoder.so \
    device/huawei/angler/aptx/lib64/libaptX_encoder.so:system/lib64/libaptX_encoder.so \
    device/huawei/angler/aptx/lib64/libaptXHD_encoder.so:system/lib64/libaptXHD_encoder.so \
